...
class UvaPadovaSimulator:
    ...
    def doSimulation(self, carbohydrate: float, insulin: float, step_time:int = 5):
        """
        ...
        self.__buildScenario(carbohydrate, insulin, step_time)
        ...
        return self.patient.cgm[self.tEndReal][0]

    def __buildScenario(self, carbohydrate: float, insulin: float, step_time):
